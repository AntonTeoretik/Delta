...
Так же у каждого может быть определена ассоциативность. Левоассоциативные и правоассоциативные операторы позволяют записывать без скобок выражения вида `a * b * c`
...
После этого, для левоассоативного оператора надо написать infixl, для правоассоциативного надо написать infixr, а для не ассоциативного надо написать infix. После этого слова надо указать число от 1 до 9 (его приоритет) и наконец написать сам оператор. Наконец, после этого надо реализовать сам оператор как обычную функцию (не забыв заключить оператор в скобки.)
